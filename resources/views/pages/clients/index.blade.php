    ...
    <div x-data="{
        ...
        <div class="flex flex-col justify-between gap-5 border-b border-gray-200 px-5 py-4 sm:flex-row sm:items-center dark:border-gray-800">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('clients.export') }}" title="Export CSV" class="shadow-theme-xs inline-flex items-center justify-center gap-2 rounded-lg bg-white px-3 sm:px-4 py-2.5 text-sm font-medium text-gray-700 ring-1 ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
                ...
                <a href="{{ route('import.index') }}" title="Import Data" class="shadow-theme-xs inline-flex items-center justify-center gap-2 rounded-lg bg-white px-3 sm:px-4 py-2.5 text-sm font-medium text-gray-700 ring-1 ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
                ...
                @if(auth()->check())
                <a href="{{ route('clients.create') }}" title="Add Client" class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex items-center justify-center gap-2 rounded-lg px-3 sm:px-4 py-2.5 text-sm font-medium text-white transition">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 20 20" fill="none">
        ...
        <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
            <div class="flex items-center justify-between gap-3">
                <form action="{{ route('clients.index') }}" method="GET" class="flex flex-wrap items-center gap-2">
                    @if(request('status'))
                    ...
                    <div class="relative w-[260px]">
                        ...
                        @if(request('search'))
                            <a href="{{ route('clients.index', request()->except(['search', 'page'])) }}" class="absolute top-1/2 right-3 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors">
                    ...
                    @if(request('search'))
                        <a href="{{ route('clients.index', request()->except(['search', 'page'])) }}" class="shadow-theme-xs inline-flex h-10 items-center justify-center gap-1.5 rounded-lg border border-gray-300 bg-white px-4 text-sm font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="relative">
                    ...
                    <div x-show="showFilter" @click.away="showFilter = false" x-transition style="width: 380px;" class="absolute right-0 z-10 mt-2 rounded-lg border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800">
                        <form action="{{ route('clients.index') }}" method="GET" class="space-y-5">
                            ...
                            <div>
                                <label class="mb-2 block text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Location</label>
                                <select name="location" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:text-white/90">
                    ...
                    <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900/50">
                        ...
                        <td class="px-5 py-4 whitespace-nowrap text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="{{ route('clients.destroy', $client) }}" method="POST" id="delete-form-{{ $client->id }}" class="inline">
                                    @csrf @method('DELETE')
