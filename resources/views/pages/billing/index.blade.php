            ...
            <table class="w-full table-auto">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900/50">
                        ...
                        <td class="px-5 py-4 whitespace-nowrap">
                            <span class="inline-flex rounded-full px-2 py-0.5 text-[5px] font-bold uppercase
                        ...
                        <td class="px-5 py-4 whitespace-nowrap text-right">
                            <div x-data="{ open: false }" class="relative inline-block text-left">
                                ...
                                <div x-show="open" @click.away="open = false" class="absolute right-0 z-50 mt-2 w-40 rounded-xl border border-gray-100 bg-white p-2 shadow-lg dark:border-gray-800 dark:bg-gray-900">
                                    <a href="{{ route('billing.show', $billing) }}" class="flex w-full px-3 py-2 text-xs font-medium text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5">View</a>
                                    <a href="{{ route('billing.edit', $billing) }}" class="flex w-full px-3 py-2 text-xs font-medium text-gray-500 rounded-lg hover:bg-gray-100 dark:hover:bg-white/5">Edit</a>
                                    <form action="{{ route('billing.destroy', $billing) }}" method="POST" id="delete-form-{{ $billing->id }}">
                                        @csrf @method('DELETE')
