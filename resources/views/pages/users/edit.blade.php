...
@section('content')
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <x-common.page-breadcrumb pageTitle="Edit User - {{ $user->name }}" />
    </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="p-7 space-y-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            New Password <span class="text-xs text-gray-400 font-normal">(Leave blank to keep current password)</span>
                        </label>
                    ...
                    <div>
                        ...
                        @if($user->id === auth()->id())
                            ...
                            <input type="text" value="Admin (Cannot change own role)" disabled
                                class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-gray-50 dark:bg-white/[0.02] px-4 py-2.5 text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400 transition" />
                        @else
                            <div x-data="{
                                open: false,
                                search: '',
            ...
            <div class="p-7 space-y-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="location" value="{{ old('location', $user->location) }}" placeholder="e.g. London"
                            class="dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:text-white/90 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 transition" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="bio" rows="4" placeholder="Brief biographical details..."
                        class="dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:text-white/90 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 transition">{{ old('bio', $user->bio) }}</textarea>
                </div>
            </div>
        </div>
