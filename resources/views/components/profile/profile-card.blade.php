    ...
    <div class="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                <div class="h-20 w-20 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800 bg-gray-100 flex items-center justify-center">
                    @if(auth()->user()->profile_photo_path)
                        <img src="{{ auth()->user()->profile_photo_url }}" alt="user" />
                    @else
                        <span class="text-2xl font-bold text-brand-500 uppercase">{{ substr(auth()->user()->name, 0, 1) }}</span>
                    @endif
                </div>
                ...
                <div class="order-2 flex grow items-center gap-2 xl:order-3 xl:justify-end">
                    ...
                    @else
                        <div class="opacity-40 cursor-not-allowed shadow-theme-xs flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">
                    @endif
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-3">
                            <div>
                                ...
                                <input type="text" name="facebook" value="{{ auth()->user()->facebook ?? '' }}" placeholder="https://facebook.com/..."
                            ...
                            <div>
                                ...
                                <input type="text" name="twitter" value="{{ auth()->user()->twitter ?? '' }}" placeholder="https://x.com/..."
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="linkedin" value="{{ auth()->user()->linkedin ?? '' }}" placeholder="https://linkedin.com/..."
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="instagram" value="{{ auth()->user()->instagram ?? '' }}" placeholder="https://instagram.com/..."
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
                        </div>
                    </div>
                    <div class="mt-7">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-3">
                            ...
                            <div class="col-span-2 lg:col-span-1">
                                ...
                                <input type="text" name="last_name" value="{{ str_replace(explode(' ', auth()->user()->name)[0], '', auth()->user()->name) ?: '-' }}"
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
