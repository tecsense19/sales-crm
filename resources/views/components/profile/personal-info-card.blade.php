            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-32">
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ explode(' ', auth()->user()->name)[0] }}</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Last Name</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ str_replace(explode(' ', auth()->user()->name)[0], '', auth()->user()->name) ?: '-' }}</p>
                    </div>
