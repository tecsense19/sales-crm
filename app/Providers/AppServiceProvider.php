...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Background Queue Worker Trigger Logic
        $triggerWorker = function ($notifiable = null) {
            // Use a short cache lock to prevent spawning multiple workers simultaneously for the same batch
